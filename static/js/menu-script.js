...
defaultPosition = indicatorPosition = activeElement.position().top + activeElement.height()/2 - 5;
...
$("#cssmenu > ul > li").hover(function() {
  activeElement = $(this);
  indicatorPosition = activeElement.position().top + activeElement.height()/2 - 5;
  indicator.css("top", indicatorPosition);
}, 
function() {
